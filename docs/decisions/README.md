...
| [0012](0012-wire-protocol-as-per-model-capability.md) | Wire protocol as a per-model capability | 🟡 Proposed — **not implemented**; 3 measured `api_path` drifts, operator override inert; designs for Anthropic Messages as the 4th protocol |
