...
**Date:** 2026-04-29
**Status:** Accepted — implemented (Pattern A `RichCommandContext` proxy, Textual inline on `app.py`, Pattern B `ServerCommandContext` explicit delegation — all three in `ppxai/commands/context.py`)
**Related:**
