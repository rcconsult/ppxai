...
| 4 | Manual testing & refinement | ✅ Complete | v1.11.5-v1.11.6 |
| 5 | `/agent` loop implementation | 🎯 **Next** | v1.11.7 |
| 6 | Testing & documentation | ⏳ Pending | v1.11.7 |

**Note**: v1.11.6 also removed all legacy code (AIClient, PerplexityClientPromptTools, tool_manager). EngineClient is now the only client interface.
