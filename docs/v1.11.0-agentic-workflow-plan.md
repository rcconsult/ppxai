...
### Phase 1: Native File Editing Tools (4-6 hours)

**Goal**: Create safe, atomic file editing tools in `ppxai/engine/tools/builtin/editor.py`
...
Test each tool individually without /agent:
