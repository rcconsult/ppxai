...
Branch: `bugfix/v1.19.3`. The first two entries make an existing silent degradation VISIBLE, without changing what the send path does or changing a resolved fact value. The other two close out the 2026-09-27 Sonar chat-completions retirement on the web_search tool's own code path.
