#!/bin/bash
#
# Create ppxaide.icns from ppxaide-transparent.png with proper transparency
#

set -e

SOURCE="resources/ppxaide-transparent.png"
ICONSET="resources/ppxaide.iconset"
OUTPUT="resources/ppxaide.icns"

echo "========================================"
echo "Creating ppxaide.icns with transparency"
echo "========================================"
...
if [ -f "$OUTPUT" ]; then
    ...
    echo "Backed up old icon to ${OUTPUT}.old"
fi
...
sips -g hasAlpha "$OUTPUT" | grep hasAlpha
