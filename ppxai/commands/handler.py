...
class CommandHandler:
    ...
    # ===========================================================================
    # DEPRECATED METHODS - v1.13.10
    # ===========================================================================
    # The following methods have been migrated to the Command Factory pattern.
    # They are kept here for reference and will be REMOVED in v1.14.x.
    #
    # Migrated to:
    #   - session.py: handle_save, handle_export, handle_sessions, handle_load
    #   - provider.py: handle_model, handle_provider, handle_autoroute
    #   - system.py: handle_help, handle_theme, handle_status, handle_spec
    #   - coding.py: handle_generate, handle_test, handle_docs, handle_implement,
    #               handle_debug, handle_explain, handle_convert
    #   - utility.py: handle_cd, handle_pwd, handle_config, handle_debug_log, handle_context
    #   - tools.py: handle_tools, handle_usage
    #   - display.py: handle_show
    #   - agent.py: handle_agent, handle_undo, handle_checkpoint
    # ===========================================================================
    ...
    # cwd = self.engine_client.get_working_dir() or "[dim]not set[/dim]"
