...
| `tests/test_no_new_lazy_imports.py` | No new function-level internal import; no `if TYPE_CHECKING:`; `ppxai/engine/` imports nothing from `ppxai.commands`; `config/` imports nothing from `engine/` |
